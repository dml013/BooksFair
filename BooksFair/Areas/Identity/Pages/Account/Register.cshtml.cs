...
namespace BooksFair.Areas.Identity.Pages.Account {
    [AllowAnonymous]
    public class RegisterModel : PageModel {
        ...
        public async Task OnGetAsync(string returnUrl = null) {
            ...
            Input = new InputModel() {
                ...
                //.Where(u => u.Name!=SD.RoleUserIndi)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null) {
            ...
            if ( ModelState.IsValid ) {
                ...
                if ( result.Succeeded ) {
                    ...
                    if ( !await _roleManager.RoleExistsAsync(SD.RoleUserComp) ) {
                        await _roleManager.CreateAsync(new IdentityRole(SD.RoleUserComp));
                    }
                    if ( !await _roleManager.RoleExistsAsync(SD.RoleUserIndi) ) {
                    ...
                    if ( user.Role == null ) {
                        ...
                        if ( user.CompanyId != 0 )
                            await _userManager.AddToRoleAsync(user, SD.RoleUserComp);
                        else {
